...
class SearchChain(ChainBase):
    ...
    def search_by_id(self, tmdbid: Optional[int] = None, doubanid: Optional[str] = None, bangumiid: Optional[int] = None, steamid: Optional[int] = None, javdbid: Optional[str] = None,
