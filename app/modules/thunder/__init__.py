...
from app.modules.thunder.thunder import Thunder
...
class ThunderModule(_ModuleBase, _DownloaderBase[Thunder]):
    ...
    def init_module(self) -> None:
        ...
        初始化模块
        """
        super().init_service(service_name=Thunder.__name__.lower(),
                             service_type=Thunder)
    ...
    def download(self, content: Union[Path, str], download_dir: Path, cookie: str,
        ...
        if not state:
            ...
            if error:
                return None, None, None, "无法连接thunder下载器"
            if torrents:
